package com.playko.messagingservice.configuration.security.jwt;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        rolesEndpointsMap.put("ROLE_ADMIN", Arrays.asList("/messaging/v1/send-notification"));
        rolesEndpointsMap.put("ROLE_PARTNER", Arrays.asList("/messaging/v1/send-notification"));
